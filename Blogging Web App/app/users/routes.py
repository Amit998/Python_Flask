...
from app.users.form import RegistrationForm,LoginForm,UpdateAccountForm,RequestResetForm,ResetPasswordForm
...
from app.users.form import RegistrationForm,LoginForm,UpdateAccountForm,RequestResetForm,ResetPasswordForm
from app.users.utils import save_picture,send_rest_email
...
def reset_request():
    ...
    if (form.validate_on_submit()):
        ...
        flash('An email has been send to rest your password','info')
